 ...
 */
$config['site_title']                 = "Sistema de Controle";       // Site Title, example.com This is not more functional
$config['admin_email']                = "marconipereirajp@hotmail.com"; // Admin Email, admin@example.com This is not more functional
